...
part1 <- load1030Bucket(symbols.naig, start.date, end.date)
part2 <- load1330Bucket(symbols.naig, start.date, end.date)  
part3 <- load1630Bucket(symbols.naig, start.date, end.date)
...
html <- paste(outputDir,'/highreturns.html',sep='')
knit2html(input="HighReturnGraph.Rmd",output=html)
