...
rolling_vol <- function(da_ta=da_ta, ra_nge=NULL, se_ries=colnames(da_ta[, 1]), win_dow=10) {
...
foo_bar <- rolling_vol(da_ta, ra_nge="2015-03-01/2015-11-25", se_ries="Apr.16", win_dow=20)
